...
def title(im):
    Y_POSITION1 = 60
    background_functions.create_rounded_rectangle(image=im, size=(484, 80), corner_radius=25, color=(0,0,0,OPACITY), position=(IMAGE_SIZE[0]/2, Y_POSITION1))
    ...
    Y_POSITION2 = 135
    background_functions.create_rounded_rectangle(image=im, size=(270, 55), corner_radius=15, color=(0,0,0,OPACITY), position=(IMAGE_SIZE[0]/2, Y_POSITION2))
...
def create_backgrounds(im):
    for height in range(10):
        background_functions.create_rounded_rectangle(image=im, size=SIZE, corner_radius=15, color=(0,0,0,OPACITY), position=(336,TOP_Y_POSITION + height*(STEP)))
        background_functions.create_rounded_rectangle(image=im, size=PLACEMENT_SIZE, corner_radius=15, color=(0,0,0,OPACITY), position=(41,TOP_Y_POSITION + height*(STEP)))
